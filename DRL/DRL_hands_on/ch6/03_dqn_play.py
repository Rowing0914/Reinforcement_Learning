...
import gym, time, argparse, torch, collections
...
if __name__ == '__main__':
	...
	parser.add_argument("--no-visualize", default=True, action="store_false", help="Disable visualisation of the game play")
