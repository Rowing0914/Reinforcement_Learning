...
def q_hat_learning(env, num_episodes, BETA=0.5, discount_factor=1.0, alpha=0.5, epsilon=0.1):
    """
    ...
    for i_episode in range(num_episodes):
        ...
        for t in itertools.count():
            ...
            td_delta = max(td_target, Q[state][action])
...
Q = q_hat_learning(env, 500, BETA=0.0)
print(Q)
