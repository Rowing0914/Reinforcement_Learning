...
def Ex_Sarsa(env, Q, alpha=0.5, discount_factor=1.0, epsilon=0.1, num_episodes=1000):
...
if __name__ == '__main__':
    ...
    _, stats_ex_sarsa = Ex_Sarsa(env, Q, alpha=ALPHA, discount_factor=DISCOUNT_FACTOR, num_episodes=NUM_EPISODES)
    ...
    stats = {'Q-Learning': stats_Q, 'Sarsa': stats_sarsa, "ex_sarsa": stats_ex_sarsa}
    compare_plots(**stats)